...
<head>
  ...
  <title>Order - Online Ordering System</title>
...
if (!$order) {
    echo "<p class='text-center text-red-600'>Order not found.</p>";
    exit();
}
...
?>
          ...
          <div class="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
            ...
            <p class="mb-4">Your order has been successfully placed. Below are the details of your order:</p>
            ...
            <div class="flex justify-between items-center border-t pt-4">
              ...
              <span class="text-xl font-bold">₹ <?php echo number_format($order['total_price'], 2); ?></span>
            </div>

            <div class="mt-6 text-center">
              <p class="text-gray-600 mb-4">You will be redirected to the home page in 5 seconds.</p>
